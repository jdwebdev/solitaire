...
class Hanzi {
    ...
    static tangoList = [];
    static fuxiList = [];
    static fuxiraw = "醋衬烧拐刚戴假助陪舒净舍厅厕害咱玉糕刮预枫涂糊楚撞领融炼拆搬装傅爬拳戏懒剧懂转护糟垃圾透府霉栽砍灯染掉严原脾巴岂毕确咸橙裔俄榄饮橄猪矮臂胶针扮肩膀帅督乳曲踢遛颐卷捡及责摄蛇景阳译收扬彩圆摘捧泼巧夸伙萝聪鹅卜帖贺申邯篇魁郸奇娱联绝播偶续李膏坛根直殊牌拾括兜显碰积赚挤棋顾虽峰富余响计般泽坚稀邓据划埋编端按伯压坟杭蝴墓劝梁仙郑货忍居摆逛搭帛载印赢奖输丝岗技犹疯脆培吊烈豫怜适庄瞒妆挣虑仅即贷拢诞瑰玫宵挚唆啰嗦";
    ...
    constructor(pKanji, pReading, pFanti, pFuxi) {
        ...
        this.fanti = pFanti;
        this.bFuxi = (pFuxi != "");
        if (this.bFuxi) Hanzi.fuxiList.push(this);
        this.examples = "";
        this.exList = [];
        this.insertZword();
