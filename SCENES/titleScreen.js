class TitleScreen {
    ...
    static init() {
        ...
        let normalBtnLeft = new Sprite({ w: 16, h: 16 }, -20, 3, normalBtn, "TitleScreen");
        ...
        let normalBtnRight = new Sprite({ w: 16, h: 16 }, normalBtn.width + 3, 3, normalBtn, "TitleScreen");
        ...
        let pixelBtnLeft = new Sprite({ w: 16, h: 16 }, -20, 3, pixelBtn, "TitleScreen");
        pixelBtnLeft.addAnimation("normal", { x: 0, y: 560 }, 4, [firstFrameSpeed, 0.05, 0.1, 0.05]);
        pixelBtnLeft.changeAnimation("normal");
        TitleScreen.list.push(pixelBtnLeft);
        let pixelBtnRight = new Sprite({ w: 16, h: 16 }, pixelBtn.width + 3, 3, pixelBtn, "TitleScreen");
        pixelBtnRight.addAnimation("normal", { x: 0, y: 560 }, 4, [firstFrameSpeed, 0.05, 0.1, 0.05]);
        ...
        let kanjiBtnLeft = new Sprite({ w: 16, h: 16 }, -20, 3, kanjiBtn, "TitleScreen");
        kanjiBtnLeft.addAnimation("normal", { x: 0, y: 576 }, 4, [firstFrameSpeed, 0.05, 0.1, 0.05]);
        kanjiBtnLeft.changeAnimation("normal");
        TitleScreen.list.push(kanjiBtnLeft);
        let kanjiBtnRight = new Sprite({ w: 16, h: 16 }, kanjiBtn.width + 3, 3, kanjiBtn, "TitleScreen");
        kanjiBtnRight.addAnimation("normal", { x: 0, y: 576 }, 4, [firstFrameSpeed, 0.05, 0.1, 0.05]);
        ...
        let hanziBtnLeft = new Sprite({ w: 16, h: 16 }, -20, 3, hanziBtn, "TitleScreen");
        hanziBtnLeft.addAnimation("normal", { x: 0, y: 592 }, 4, [firstFrameSpeed, 0.05, 0.1, 0.05]);
        hanziBtnLeft.changeAnimation("normal");
        TitleScreen.list.push(hanziBtnLeft);
        let hanziBtnRight = new Sprite({ w: 16, h: 16 }, hanziBtn.width + 3, 3, hanziBtn, "TitleScreen");
        hanziBtnRight.addAnimation("normal", { x: 0, y: 592 }, 4, [firstFrameSpeed, 0.05, 0.1, 0.05]);
